# Somatic Variant Calling Pipeline (GATK4 Mutect2)

This notebook demonstrates a step-by-step workflow for calling somatic variants from WGS data using GATK4 Mutect2, following GATK Best Practices.  
**All paths are relative to a root directory called `Project`.**

---

## 1. Download Sequencing Reads

# Create reads directory and download FASTQ files
...
# Subset 1,000,000 reads from each FASTQ for demonstration
...
# Download and prepare reference genome and known sites
...
# Download TruSeq3-PE.fa if not present
...
# Merge overlapping reads with BBMerge
...
## 7. Mark Duplicates and Sort (GATK MarkDuplicatesSpark)
...
| Step | Purpose                                      | Directory/Output Example                                  |
|------|----------------------------------------------|-----------------------------------------------------------|
| 1    | Download reads                               | Project/reads/                                            |
| 2    | Subset reads                                 | Project/reads/                                            |
| 3    | Prepare reference files                      | Project/supporting_files/hg38/                            |
| 4    | QC with FastQC                               | Project/reads/fastqc/                                     |
